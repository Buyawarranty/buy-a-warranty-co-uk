                        ...
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              className="flex-1 flex items-center justify-center gap-2 bg-white border border-gray-300 hover:bg-gray-50 rounded-lg py-3 px-4 transition-colors duration-200"
                            >
                              <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                              </svg>
                              <span className="font-medium text-gray-900">View PDF Details</span>
                            </button>
                            ...
                            {pdfUrls[plan.name.toLowerCase()] && (
                              <a
                                ...
                                className="flex items-center justify-center bg-white border border-gray-300 hover:bg-gray-50 rounded-lg py-3 px-3 transition-colors duration-200"
                                title="Download PDF"
                              >
                                <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            {pdfUrls[plan.name.toLowerCase()] ? (
                              <div className="relative">
                                <div className="bg-gray-100 px-4 py-3 border-b border-gray-200 flex items-center justify-between">
                                  <h4 className="font-semibold text-gray-900">{plan.name} Plan - Full Policy Document</h4>
                                  <button
                                ...
                                <div className="p-6 text-center bg-gray-50">
                                  ...
                                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Policy Document Ready</h3>
                                  <p className="text-gray-600 mb-6">Click the button below to view or download the complete {plan.name.toLowerCase()} plan policy document.</p>
                                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                                    <a
                                      href={pdfUrls[plan.name.toLowerCase()]}
                                      target="_blank"
                                      rel="noopener noreferrer"
                                      className="inline-flex items-center justify-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium"
                                    >
                                    ...
                                    <a
                                      href={pdfUrls[plan.name.toLowerCase()]}
                                      download
                                      className="inline-flex items-center justify-center px-6 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors text-sm font-medium"
                                    >
