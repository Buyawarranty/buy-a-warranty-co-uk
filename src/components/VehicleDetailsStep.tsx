        ...
        <form onSubmit={handleSubmit}>
          ...
          {!showManualEntry && !vehicleFound && (
            <button 
              ...
              className="w-full max-w-[520px] mx-auto block text-white text-[15px] font-bold py-[12px] px-[20px] rounded-[6px] mb-4 border-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
              style={{
