         ...
         <div className="flex flex-col items-center">
          ...
          {!showManualEntry && !vehicleFound && (
            <button 
              ...
              className="w-full max-w-[520px] block text-white text-[15px] font-bold py-[20px] sm:py-[24px] px-[20px] rounded-[6px] mb-4 border-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
              style={{
