...
import carWarrantyHero from '@/assets/car-warranty-hero-1.png';
import pandaCarWarranty from '@/assets/panda-car-warranty-hero.png';
import pandaFastService from '@/assets/panda-fast-service.png';
